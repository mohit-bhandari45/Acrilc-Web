...
const sections: Section[] = [
    ...
    { id: "contact", name: "Contact" }, // Add this line
]
...
useEffect(() => {
    const observerOptions = {
        threshold: 0.2, // Single threshold for consistent triggering
        rootMargin: "-10% 0px", // Adjusted rootMargin for better detection
    };
    ...
    className={`min-h-screen px-10 py-20 transition-all duration-500 ${
        activeSection === "about" ? "opacity-100 blur-0" : "opacity-30 blur-sm"
    }`}
>
                {/* About Section */}
...
<section
    ...
    className={`min-h-screen px-10 py-20 transition-all duration-300 ${
        activeSection === "gallery" ? "opacity-100" : "opacity-30 blur-[1px]"
    }`}
>
    <div className="max-w-6xl mx-auto">
        <h2 className="font-serif text-4xl mb-5 text-center">Gallery</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredGalleryItems.map((item) => (
                <div
                    key={item.id}
                    onClick={() => setSelectedImage(`/placeholder.svg?height=600&width=600`)}
                    className={`aspect-square ${item.color} rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:shadow-xl hover:-translate-y-1`}
                >
    ...
    className={`min-h-screen px-10 py-20 transition-all duration-500 ${
        activeSection === "shop" ? "opacity-100 blur-0" : "opacity-30 blur-sm"
    }`}
>
                    <div className="max-w-6xl mx-auto">
    ...
    className={`min-h-screen px-10 py-20 transition-all duration-500 ${
        activeSection === "contact" ? "opacity-100 blur-0" : "opacity-30 blur-sm"
    }`}
>
                    <div className="max-w-6xl mx-auto">
