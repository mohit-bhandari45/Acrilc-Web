					...
					<div className="space-y-4">
						<div className="relative">
							<Input
								...
								className={`mb-2 rounded-xl border-2 transition-all duration-300 py-3 px-4 text-gray-700 placeholder-gray-400 focus:border-orange-400 focus:ring-4 focus:ring-orange-100 hover:border-orange-300 ${error
