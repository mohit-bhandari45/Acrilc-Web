                ...
                {items.slice(0, 6).map((it, index) => (
                    ...
                    >
                        ...
                        <div className="h-52 overflow-hidden relative">
                            ...
                            />
                            <div className="absolute top-3 left-3 rounded-full bg-[#2e1a10]/70 px-3 py-1 text-sm font-semibold text-white backdrop-blur-sm">
                        ...
                        <div className="p-5 flex flex-col gap-2">
                            <div className="flex items-start justify-between gap-2">
                                <h4 className="font-bold text-base text-[#2e1f14] leading-tight">{it.title}</h4>
                                <span className="flex-shrink-0 inline-flex items-center rounded-full bg-[#f5e6dc] px-2.5 py-0.5 text-xs font-semibold text-[#834C3D]">
                                    {it.forte}
                                </span>
                            </div>

                            <p className="text-sm text-[#7a5a49] leading-relaxed line-clamp-2">{it.description}</p>

                            <p className="text-xs text-[#9a8578]">{it.yearOfMaking}</p>

                            <button className="mt-2 w-full h-10 rounded-full border border-[#8f5b42]/10 bg-[linear-gradient(135deg,#834C3D_0%,#a8664f_55%,#d38d67_100%)] text-sm font-semibold text-white shadow-[0_8px_20px_rgba(131,76,61,0.22)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(131,76,61,0.32)]">
                                Add to Collection
                            </button>
                        </div>
                    </div>
