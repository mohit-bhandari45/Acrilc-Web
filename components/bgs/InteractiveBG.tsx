    ...
    <>
      <style jsx>{`
        ...
        @keyframes pulse-glow {
          ...
          50% {
            filter: brightness(1.3) blur(25px);
          }
        }
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              ...
              transform: `translate(${
                mousePos.x * 0.03 + Math.sin(Date.now() * 0.001) * 10
              }px, ${mousePos.y * 0.03 + Math.cos(Date.now() * 0.001) * 8}px) ${
                isMouseDown ? "scale(1.2)" : "scale(1)"
              }`,
              top: "10%",
              left: "20%",
          ...
          <div
            ...
            style={{
              ...
              background: `radial-gradient(ellipse ${
                100 + hoverIntensity * 20
              }% ${100 - hoverIntensity * 10}%, 
                rgba(255,122,0,${0.15 + hoverIntensity * 0.1}) 0%, 
                rgba(255,122,0,${0.07 + hoverIntensity * 0.05}) 70%, 
                transparent 100%)`,
              filter: `blur(${15 + hoverIntensity * 8}px)`,
              transform: `translate(${mousePos.x * -0.02 + scrollY * 0.1}px, ${
                mousePos.y * -0.02 + Math.sin(Date.now() * 0.0015) * 15
              }px) rotate(${Date.now() * 0.01}deg)`,
              top: "55%",
              right: "15%",
              animationDelay: "1s",
            }}
          ...
          <div
            ...
            style={{
              ...
              background: `radial-gradient(circle, 
                ...
                transparent 100%)`,
              filter: `blur(${12 + hoverIntensity * 6}px) hue-rotate(${
                Math.sin(Date.now() * 0.001) * 20
              }deg)`,
              transform: `translate(${
                mousePos.x * 0.015 + Math.sin(Date.now() * 0.002) * 25
              }px, ${
                mousePos.y * 0.015 + Math.cos(Date.now() * 0.0025) * 20
              }px)`,
              bottom: "25%",
              left: "12%",
              animationDelay: "2s",
        ...
        <div
          ...
          style={{
            backgroundImage: `
              linear-gradient(rgba(255,122,0,${
                0.05 + hoverIntensity * 0.03
              }) 1px, transparent 1px),
              linear-gradient(90deg, rgba(255,122,0,${
                0.05 + hoverIntensity * 0.03
              }) 1px, transparent 1px)
            `,
            backgroundSize: `${40 + hoverIntensity * 10}px ${
              40 + hoverIntensity * 10
            }px`,
            transform: `translate(${mousePos.x * 0.008 + scrollY * 0.02}px, ${
              mousePos.y * 0.008
            }px) rotate(${hoverIntensity * 2}deg)`,
        ...
        {hoverIntensity > 0.3 && (
          <div
            ...
            style={{
              ...
              top: mousePos.y,
              transform: `rotate(${
                (Math.atan2(mousePos.y, mousePos.x) * 180) / Math.PI
              }deg)`,
