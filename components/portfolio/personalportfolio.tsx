...
export default function PersonalPort({
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 space-y-8">
      <div>
        <h2 className="text-3xl font-bold mb-6 mt-15 mx-10 lg:mx-0">Portfolio</h2>

        <div className="grid mx-10 lg:mx-0 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 transition duration-1000 ease-in-out">
