    ...
    <div className="h-screen w-full flex flex-col justify-center items-center relative overflow-hidden transition-colors duration-500">
      ...
      <style jsx>{`
        ...
        @keyframes gradient-move {
          ...
          25% {
            transform: translateX(20%) translateY(-30%) rotate(90deg);
          }
          50% {
            transform: translateX(-30%) translateY(20%) rotate(180deg);
          }
          75% {
        ...
        @keyframes gradient-move-reverse {
          ...
          75% {
            transform: translateX(-20%) translateY(-30%) rotate(-270deg);
          }
          100% {
            transform: translateX(20%) translateY(20%) rotate(-360deg);
          }
        ...
        @keyframes float-medium {
          ...
          66% {
            transform: translate(50px, -25px) scale(0.85);
          }
        }
