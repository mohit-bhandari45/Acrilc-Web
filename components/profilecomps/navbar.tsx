        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-8">
            <nav className="hidden md:flex space-x-10">
              <Link
                href="/"
                className={`text-sm text-black hover:underline underline-offset-2 transition ease-in-out duration-1000`}
              >
                Home
              </Link>
              <Link
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/profile"
                className="bg-yellow-500 text-white font-medium text-sm rounded-full px-5 py-2"
              >
                Profile
              </Link>
              ...
              <Link href="/profile" className="flex items-center">
                <div className="h-8 w-8 rounded-full overflow-hidden bg-black">
                  {!user?.profilePicture ? (
                    <Image
